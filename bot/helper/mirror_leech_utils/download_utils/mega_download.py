...
# Try to import MEGA SDK, but make it optional
try:
    from mega import MegaApi, MegaListener, MegaRequest, MegaTransfer, MegaError
    MEGA_SDK_AVAILABLE = True
except ImportError:
    LOGGER.warning("MEGA SDK not available. MEGA downloads will be disabled.")
...
async def add_mega_download(mega_link, path: str, listener, name: str):
    if not MEGA_SDK_AVAILABLE:
        await sendMessage("❌ MEGA SDK is not available. MEGA downloads are disabled on this instance.", listener.message)
        return
